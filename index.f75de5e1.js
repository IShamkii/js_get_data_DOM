...
const totalPopulation = population.reduce((acc, item)=>acc + getValue(item.innerText), 0);
const total = [
...
average[0].replaceWith((totalPopulation / population.length).toLocaleString("en-US"));
